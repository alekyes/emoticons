...
* В NVDA 2017.4 или позднее, параметры конфигурации и пользовательские словари будут изменяться автоматически в соответствии с выбранными профилями. В 2017.3 или более ранних версиях, вы можете применить изменения,  перезагрузив плагины (нажав control+NVDA+f3).
* Если вы выберите импорт настроек при обновлении дополнения, устаревшие файлы (emoticons.ini и emoticons.dic) будут удалены или адаптированы к этой версии.
